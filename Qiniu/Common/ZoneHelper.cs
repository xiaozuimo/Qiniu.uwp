...
namespace Qiniu.Common
{
    public class AutoZone
    {
        ...
        public static async Task<ZoneID> Query(string accessKey, string bucketName)
        {
            ...
            try
            {
                ...
                wReq.Method = "GET";
                System.Net.HttpWebResponse wResp = await wReq.GetResponseAsync() as System.Net.HttpWebResponse;
